    ...
    if self.csr is None:
      self.csr = x509.CertificateSigningRequestBuilder() \
        .subject_name(x509.Name([
          ...
          x509.NameAttribute(x509.NameOID.ORGANIZATION_NAME, 'Xorvenia'),
          x509.NameAttribute(x509.NameOID.ORGANIZATIONAL_UNIT_NAME, 'IT and Security Engineering'),
          ...
          x509.NameAttribute(x509.NameOID.EMAIL_ADDRESS, 'xorvenia@thoughtparameters.com'),
